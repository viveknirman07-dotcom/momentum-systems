      ...
      <section className="section-spacing border-t border-[hsl(var(--line-hair))]">
        <div className="container-standard">
          ...
          <div className="grid md:grid-cols-3 gap-12 lg:gap-16">
            {pillars.map((pillar, index) => <div key={index} className="fade-in" style={{
      ...
      <section className="section-spacing border-t border-[hsl(var(--line-hair))]">
        <div className="container-standard">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {testimonials.map((testimonial, index) => <div key={index} className="border border-[hsl(var(--line-hair))] rounded-xl p-6 bg-[hsl(var(--card))] hover-lift">
